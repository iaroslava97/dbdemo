...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(MyownContext context)
		{
		...
		static void FilterAndOrder(MyownContext context)
		{
		...
		static void Join(MyownContext context)
		{
			var result = from s in context.Students
		...
		static void GroupByFirstLetter(MyownContext context)
		{
			var result = from s in context.Students
		...
		{
			using (MyownContext c = new MyownContext())
			{
